...
interface CaseStudy04RenewcellToolkitNewProps {
  isExpanded?: boolean;
  onToggle?: () => void;
}

export function CaseStudy04RenewcellToolkitNew({ isExpanded, onToggle }: CaseStudy04RenewcellToolkitNewProps = {} as CaseStudy04RenewcellToolkitNewProps) {

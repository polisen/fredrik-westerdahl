...
interface CaseStudy01SublinkNewProps {
  isExpanded?: boolean;
  onToggle?: () => void;
}

export function CaseStudy01SublinkNew({ isExpanded, onToggle }: CaseStudy01SublinkNewProps = {} as CaseStudy01SublinkNewProps) {

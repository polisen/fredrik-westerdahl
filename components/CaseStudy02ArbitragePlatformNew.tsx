...
interface CaseStudy02ArbitragePlatformNewProps {
  isExpanded?: boolean;
  onToggle?: () => void;
}

export function CaseStudy02ArbitragePlatformNew({ isExpanded, onToggle }: CaseStudy02ArbitragePlatformNewProps = {} as CaseStudy02ArbitragePlatformNewProps) {
  ...
  return (
    ...
    >
      ...
      {/* Outcome section */}
      {sections['Outcome'] && (
        <div className="rounded-lg py-2 px-8 pb-16">

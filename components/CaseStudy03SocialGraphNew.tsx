...
interface CaseStudy03SocialGraphNewProps {
  isExpanded?: boolean;
  onToggle?: () => void;
}

export function CaseStudy03SocialGraphNew({ isExpanded, onToggle }: CaseStudy03SocialGraphNewProps = {} as CaseStudy03SocialGraphNewProps) {
